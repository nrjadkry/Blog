...
from .views import UserRegisterView, UserEditView, PasswordsChangeView, password_success,profile, EditProfilePageView
...
urlpatterns = [
	...
	path('<int:pk>/editmy_profile/',EditProfilePageView.as_view(),name='edit-profile'),
